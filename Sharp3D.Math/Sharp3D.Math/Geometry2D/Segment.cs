...
namespace Sharp3D.Math.Geometry2D
{
	...
	public struct Segment : ICloneable
	{
		...
		/// </summary>
		/// <param name="p0">A <see cref="Vector2F"/> instance marking the segment's starting point.</param>
		/// <param name="p1">A <see cref="Vector2F"/> instance marking the segment's ending point.</param>
		public Segment(Vector2F p0, Vector2F p1)
		{
			_p0 = p0;
			_p1 = p1;
		}
